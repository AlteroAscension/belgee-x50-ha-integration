...
- [x] user-confirmed independent Relay/Gateway pairing by one-time code;
- [x] runtime-selectable Relay push, Gateway push, Auto and local polling;
- [x] installation with either device and later pairing of the other;
